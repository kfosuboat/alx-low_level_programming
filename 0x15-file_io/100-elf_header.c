 ...
 * @e_ident: This is a pointer to an array containing the ELF magic numbers.
 *
 * Description: Magic numbers are always separated with spaces.
 */
...
/**
 * close_elf - This here closes an ELF file.
 * @elf: This is the file descriptor of the ELF file.
 *
 * Description: If the file is not able to close, then  exit with code 98.
 */
...
/**
 * main - This displays information contained in
 * the ELF header in the beginning of an ELF file.
 * @argc: The number of arguments being availed to the program.
